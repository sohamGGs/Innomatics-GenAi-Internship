...
# Initial Data (Updated with Q1 requirements)
products = [
    ...
    {"id": 3, "name": "Water Bottle", "price": 450, "category": "Lifestyle", "in_stock": False},
    {"id": 4, "name": "USB-C Cable", "price": 299, "category": "Electronics", "in_stock": True},
